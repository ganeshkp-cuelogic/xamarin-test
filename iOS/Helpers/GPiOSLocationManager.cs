...
namespace TestDemo.iOS
{
	public class GPiOSLocationManager
	{
			...
			if (CLLocationManager.LocationServicesEnabled)
			{
				...
				if (UIDevice.CurrentDevice.CheckSystemVersion(6, 0))
				{
					...
					LocMgr.LocationsUpdated += (object sender, CLLocationsUpdatedEventArgs e) =>
					{
						...
						printLocation(this, new LocationUpdatedEventArgs(e.Locations[e.Locations.Length - 1]));
					};
				...
				else
				{
					...
					{
						printLocation(this, new LocationUpdatedEventArgs(e.NewLocation));
					};
				}
		...
		public void printLocation(object sender, LocationUpdatedEventArgs arg)
		{
			CLLocation location = arg.newLocation;
	...
	public class LocationUpdatedEventArgs
	{
		...
		public LocationUpdatedEventArgs(CLLocation newLocation)
		{
